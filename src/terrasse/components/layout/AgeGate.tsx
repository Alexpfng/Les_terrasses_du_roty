...
export const AgeGate = () => {
  ...
  return (
    ...
    >
      <div style={{ display: 'grid', justifyItems: 'center', gap: 'clamp(22px, 4vh, 38px)', maxWidth: 560 }}>
        <img src={LOGOS.sunGold} alt="" width={784} height={592} style={{ width: 'clamp(90px, 14vmin, 150px)', height: 'auto' }} />
        {refused ? (
          <>
            <p id="agegate-title" className="display" style={{ margin: 0, fontSize: 'clamp(24px, 3.4vw, 40px)', lineHeight: 1.25 }}>
              Ce vin vous attendra.
            </p>
            <p style={{ margin: 0, fontSize: 13, lineHeight: 1.7, color: 'var(--ltdr-ivory-60)' }}>
              L'accès à ce site est réservé aux personnes ayant l'âge légal pour consommer de l'alcool.
            </p>
          </>
        ) : (
          <>
            ...
            <p style={{ margin: 0, fontSize: 10, letterSpacing: '0.24em', textTransform: 'uppercase', color: 'var(--ltdr-ivory-45)' }}>

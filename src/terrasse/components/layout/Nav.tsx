...
export const Nav = () => {
  ...
  return (
    ...
    >
      <a
        href="#acte-1"
        onClick={(e) => go(e, "#acte-1")}
        data-hover="1"
        style={{ display: "block", lineHeight: 0 }}
      >
        <img
          src={LOGOS.sunGold}
          alt="Les Terrasses du Roty — accueil"
          style={{ height: 34, width: "auto", display: "block" }}
        />
      </a>
      <nav
        style={{ display: "flex", alignItems: "center", gap: "clamp(18px, 2.6vw, 40px)" }}
      ...
      >
        ...
        >
          <span
            data-hdrbar="1"
            style={{ display: "block", height: 1, background: "var(--ltdr-ivory)", width: "100%" }}
          />
          <span
            data-hdrbar="1"
            style={{

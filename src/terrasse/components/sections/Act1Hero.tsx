  ...
  useGSAP(
    (_ctx, contextSafe) => {
      ...
      if (prefersReducedMotion()) {
        gsap.set(["[data-strip]", "#ltdr-title", "#ltdr-sub", "#ltdr-hint", "#ltdr-glow"], {
          opacity: 1,
        });
        return;
      }
      ...
      const buildScrub = contextSafe!(() => {
        ...
        scrub.fromTo(
          "#ltdr-sun",
          { scale: 1, opacity: 1 },
          { scale: ANIM.hero.sunScaleOut, opacity: 0, ease: "none", immediateRender: false },
          0,
        );
        scrub.fromTo(
          "#ltdr-title",
          { yPercent: 0 },
          { yPercent: -50, opacity: 0, ease: "none", immediateRender: false },
          0,
        );
        scrub.fromTo(
          "#ltdr-sub",
      ...
      tl.to(
        ...
        {
          opacity: 1,
          duration: I.stripDuration,
          ease: "power1.inOut",
          stagger: { each: I.stripStagger, from: "end" },
        },
        0,
      );
      ...
      tl.fromTo(
        "#ltdr-title",
        { opacity: 0, y: I.titleY },
        { opacity: 1, y: 0, duration: I.titleDuration, ease: "power3.out" },
        I.titleAt,
      );
    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(201,162,39,0.16) 0%, rgba(201,162,39,0.05) 40%, transparent 70%)",
          opacity: 0,
        }}
      />
      <div
      ...
      >
        ...
        >
          Les Terrasses du
          Roty&nbsp;&nbsp;·&nbsp;&nbsp;Syrah&nbsp;&nbsp;·&nbsp;&nbsp;Saint-Pourçain&nbsp;&nbsp;·&nbsp;&nbsp;Agriculture
          biologique
        </p>
      </div>
      <div

...
const captions = [
  {
    id: "cap1",
    text: "Sol argilo-calcaire.",
    pos: { left: "clamp(24px, 9vw, 140px)", top: "32%" },
  },
  {
    id: "cap2",
    text: "Exposition plein sud.",
    pos: { right: "clamp(24px, 9vw, 140px)", top: "40%" },
  },
  {
    id: "cap3",
    text: "La pierre sèche restitue la nuit la chaleur du jour.",
    pos: { left: "clamp(24px, 11vw, 180px)", bottom: "24%" },
  },
];
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          ANIM.terraces.captions.forEach((c, i) => {
            ...
            if (!el) return;
            const o =
              smoothstep(c.at, c.at + 0.06, self.progress) *
              (1 - smoothstep(c.out - 0.06, c.out, self.progress));
  ...
  return (
    <section
      ...
      style={{
        ...
        height: "100vh",
        overflow: "hidden",
        background: fallback ? "var(--ltdr-black)" : "transparent",
      }}
    >
      {fallback && (

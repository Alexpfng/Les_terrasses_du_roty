      ...
      root.querySelectorAll<HTMLElement>('[data-depth]').forEach((el) => {
        ...
        gsap.fromTo(
          ...
          { yPercent: d * amp },
          {
            yPercent: -d * amp,
            ease: 'none',
            scrollTrigger: { trigger: root, start: 'top bottom', end: 'bottom top', scrub: ANIM.parallax.scrub },
          },
        );
      });
    },
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 var(--pad-x)' }}>
        ...
        <div style={{ maxWidth: 620 }}>
          ...
          <SectionText>
            Pendant des décennies, la vigne a dormi ici. Sept terrasses de pierre sèche, rendues aux ronces, face plein sud, sous le soleil de
            Saulcet.
          </SectionText>
        </div>
        ...
        >
          <video
            ...
            loop
            playsInline
            style={{ display: 'block', width: '100%', height: 'auto', filter: 'var(--duotone) brightness(0.62)', opacity: 0.85 }}
          />
        ...
        <figure data-depth="0.2" style={{ width: 'clamp(240px, 40vw, 460px)', margin: 'clamp(12vh, 16vh, 20vh) 0 0' }}>
          <Pic
            photo={PHOTOS.drone}

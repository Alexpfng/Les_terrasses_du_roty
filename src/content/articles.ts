...
export const articles: Article[] = [
  {
    ...
    seoTitle: "Acheter du vin en direct dans l’Allier | Le guide du Roty",
    description:
  ...
  },
  {
    ...
    seoTitle: "Cavistes et restaurateurs | Découvrir la Syrah du Roty",
    description:
      "Fiche cuvée, disponibilité, quantité et conditions : préparez une demande professionnelle précise aux Terrasses du Roty, à Saulcet dans l’Allier.",
    excerpt:
      "Fiche cuvée, disponibilité, quantité et conditions : préparez une demande professionnelle précise aux Terrasses du Roty, à Saulcet dans l’Allier.",
